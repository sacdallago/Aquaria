...
(function($) {
      ...
      $(function() {
        try {
          ...
          if (window.ATL_JQ_PAGE_PROPS
              && ((window.ATL_JQ_PAGE_PROPS.triggerFunction) || (window.ATL_JQ_PAGE_PROPS["0add5080"] && window.ATL_JQ_PAGE_PROPS["0add5080"].triggerFunction))) {
            newTriggerFunction = window.ATL_JQ_PAGE_PROPS.triggerFunction
                || window.ATL_JQ_PAGE_PROPS["0add5080"].triggerFunction
          } else {
  ...
  ATL_JQ(function() {
    if ("0add5080" == "" && typeof ATL_JQ_CONFIGS == "undefined") {
      return
    }
    ...
    if (typeof ATL_JQ_CONFIGS != "undefined") {
      ...
      $
          .ajax({
            url : baseUrl
                + "/rest/collectors/1.0/configuration/trigger/0add5080?os_authType=none",
            dataType : "jsonp",
            crossDomain : true,
            jsonpCallback : "trigger_0add5080",
            cache : true,
            success : function(result) {
              showTrigger(result, "0add5080")
            }
          })
    }
  });
